    ...
    <div class="container">
      ...
      <form @submit.prevent="handleSubmit" class="register-form">
        ...
        <div class="form-group">
          ...
          <input type="text" id="name" v-model="name" placeholder="Jeannette" class="form-input"/>
        </div>

        <div class="form-group">
          <label for="surname">Nom de famille<span class="required">*</span></label>
          <input type="text" id="surname" v-model="surname" placeholder="Da Silva" class="form-input"/>
        </div>

        <div class="form-group">
          <label for="pseudo">Pseudo<span class="required">*</span></label>
          <input type="text" id="pseudo" v-model="pseudo" placeholder="Jiji" class="form-input"/>
        </div>

        <div class="form-group">
          <label for="birthdate">Date de naissance<span class="required">*</span></label>
          <input type="date" id="birthdate" v-model="birthdate" placeholder="11/11/1911" class="form-input"/>
        </div>
...
async function handleSubmit() {
  ...
  // Convertir la date et faire les validations
  ...
  const ageMinDate = new Date(today.getFullYear() - 13, today.getMonth(), today.getDate())
  if (birthdateObj > ageMinDate) {
    alert('Vous devez avoir au moins 13 ans')
    return
  }

  // Vérifier que la date n'est pas trop ancienne (exemple: avant 1900)
  if (birthdateObj.getFullYear() < 1900) {
    alert('La date de naissance doit être après le 01/01/1900')
    return
  }
